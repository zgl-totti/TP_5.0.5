...
class Wechat extends Controller{
        ...
        if(strtolower($xmlObj->MsgType)=='event'){
            ...
            if(strtolower($xmlObj->Event)=='subscribe'){
                ...
                if(strtolower($xmlObj->EventKey)=='music'){
                    ...
                    $content="<a href='http://www.tottizgl.tk/Mobile'>我的商城</a>";
                    echo $this->responseText($xmlObj,$content);
                }
            }
                       ...
                       "sub_button":[
                           {
                               "type":"view",
                               "name":"我的商城",
                               "url":"http://totti.applinzi.com/Mobile"
                           },
                           {
                                "type":"view",
                                "name":"京东商城",
    ...
    public function getUserInfoByOpenId(){
        //1 第一步：用户同意授权，获取code
        $callBack=urlencode("http://phpergy.applinzi.com/Admin/WeChat/getUserInfoNextStep");
    ...
    public function wx(){
        ...
        //生成签名
        $url="http://phpergy.applinzi.com/Admin/WeChat/wx";
